...
def variant(source, destination, name, length_scale, mass_scale, inertia_extra, motor_up, motor_down, gyro_noise_scale=1.):
    ...
    (folder/'model.config').write_text(f'<?xml version="1.0"?><model><name>{name}</name><version>1.0</version><sdf version="1.9">model.sdf</sdf></model>\n')
